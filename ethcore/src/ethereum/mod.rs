...
/// Create a new POA Indica HBBFT testnet chain spec.
pub fn new_indica<'a, T: Into<SpecParams<'a>>>(params: T) -> Spec {
	load(params.into(), include_bytes!("../../res/ethereum/poaindica.json"))
}
